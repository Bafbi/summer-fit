...
export default async function App() {
  ...
  if (
    session?.user.abonnement == "ARGENT" ||
    session?.user.abonnement == "BRONZE"
  ) {
      ...
      <main>
        <div className="wrapper">
          <div className="containerText">
            ...
            <h2>
              N'attendez plus pour commencer l'entrainement avec notre coach
              virtuel...
            </h2>
            <Link
              href="virtualCoach/newTrainingProgram"
